...
public class PropertySetWriter
{
    ...
    public void WriteTemperatureProperties(IStorage storage) =>
    ...
    public void WriteHumidityProperties(IStorage storage) =>
        OleHelper.WritePropertySet(storage, FMTID_DocSummary, new[]
        {
            (2, PROPVARIANT.LpStr("humidity")),  // name
            (3, PROPVARIANT.R8(0)),              // min
            (4, PROPVARIANT.R8(100)),               // max
            (8, PROPVARIANT.UI4(4294967295)),         // flag
            (9, PROPVARIANT.UI4(50943)),              // id
        });
}
